...
namespace PixelCrushers.DialogueSystem
{
    ...
    /// project)
    /// 	- Valid values (case-sensitive): <c>inactive</c>, <c>active</c>, <c>success</c>, 
    ...
    public static class QuestLog
    {
        ...
        /// <summary>
        /// Constant state string for inactive quests.
        /// </summary>
        public const string InactiveStateString = "inactive";
        ...
        /// </param>
        /// <example>
        /// QuestLog.AddQuest("Kill 5 Rats", "The baker asked me to bring 5 rat corpses.", QuestState.Inactive);
        /// </example>
        ...
        /// <summary>
        /// Adds a quest to the Lua Item[] table, and sets the state to Inactive.
        /// </summary>
        /// <param name='questName'>
        /// Name of the quest.
        /// </param>
        ...
        {
            AddQuest(questName, description, QuestState.Inactive);
        }
        ...
        {
            return GetQuestState(questName) == QuestState.Inactive;
        }
        ...
        public static string DefaultStateToString(QuestState state)
        {
            ...
            {
                default:
                case QuestState.Inactive: return InactiveStateString;
        ...
        //        case QuestState.Grantable: return GrantableStateString;
        //        case QuestState.ReturnToNPC: return ReturnToNPCStateString;
        //        default: return InactiveStateString;
        //    }
        //}
