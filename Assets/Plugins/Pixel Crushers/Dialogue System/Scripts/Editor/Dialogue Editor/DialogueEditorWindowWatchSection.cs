...
namespace PixelCrushers.DialogueSystem.DialogueEditor
{
    ...
    public partial class DialogueEditorWindow
    {
        ...
        private void EvaluateQuestWatch(Watch watch)
        {
            ...
            watch.questState = string.IsNullOrEmpty(questName) ? QuestState.Inactive
        ...
        private void CatalogueWatchableQuestNames()
        {
            ...
            {
                List<string> questNames = new List<string>(QuestLog.GetAllQuests(QuestState.Abandoned | QuestState.Active | QuestState.Failure | QuestState.Success | QuestState.Grantable | QuestState.ReturnToNPC | QuestState.Inactive));
                questNames.Sort();
